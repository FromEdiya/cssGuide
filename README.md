...
| <center>제목</center>  | <center>페이지</center> | <center>작성자</center> | <center>완료</center> |
| ----------------------------- | :---------------------: | :---------------------: | :-------------------: |
| [기본 스타일 규칙][기본스타일규칙]| 57 |[Santos][Santos]|  :heavy_check_mark: |
| [그룹화][그룹화] | 63 |[Santos][Santos]|  :heavy_check_mark: |
| [클래스 선택자와 ID 선택자][클래스선택자와ID선택자] | 70 |[Santos][Santos]| :heavy_check_mark: |
| [속성 선택자][속성선택자] | 78 |[Santos][Santos]| :heavy_check_mark: |
| [문서 구조][문서구조] | 91 |[Santos][Santos]| :heavy_check_mark: |
...
[속성선택자]: ./contents/02.선택자/4.속성선택자.md
[문서구조]: ./contents/02.선택자/5.문서구조.md
